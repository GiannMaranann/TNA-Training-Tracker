...
try {
    ...
    $total_result = $con->query("SELECT COUNT(*) as count FROM users WHERE department = 'CCS' AND role = 'user' AND teaching_status IS NOT NULL AND teaching_status != ''");
    if ($total_result) {
    ...
    error_log("Database error in CCS.php: " . $e->getMessage());
...
try {
    ...
    if ($pending_count) {
        ...
        if ($pending_row['count'] > 0) {
            $notifications[] = [
                'type' => 'pending',
                'message' => "You have {$pending_row['count']} pending evaluations",
...
<head>
    ...
    <style>
        ...
        /* Enhanced Sidebar Link Animations - SILVER/GRAY AND ORANGE THEME */
        .sidebar-link {
            transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
            border-radius: 15px;
            margin: 4px 0;
        ...
        @keyframes pulseEnhanced {
            ...
            50% {
                ...
                box-shadow: 0 0 0 15px rgba(249, 115, 22, 0.3);
            }
            100% { 
                transform: scale(1); 
        ...
        <aside class="sidebar-container ccs-gradient border-r border-gray-600">
            <div class="sidebar-content">
                ...
                <div class="navigation-section mb-3">
                    <nav class="mb-3">
                        <div class="space-y-1">
                            <a href="CCS.php" class="flex items-center px-3 py-2 text-white font-semibold rounded-xl sidebar-link active sliding-line active">
                                <i class="ri-dashboard-line mr-2 text-base"></i>
                                <span class="text-sm">Dashboard</span>
                                <i class="ri-arrow-right-s-line ml-auto text-base"></i>
                            </a>
                            <a href="ccs_eval.php" class="flex items-center px-3 py-2 text-white/90 font-semibold rounded-xl sidebar-link sliding-line">
        ...
        <div class="main-content">
            ...
            <header class="bg-gradient-to-r from-gray-800 to-gray-700 border-b border-gray-600">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="min-w-0">
                        <h1 class="text-2xl font-bold text-white truncate">Welcome back, <?= htmlspecialchars($user['name'] ?? 'CCS Admin') ?>! 👋</h1>
                        ...
                        <div class="p-4 card-content">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-bold text-gray-800 flex items-center">
                                    <i class="ri-time-line mr-2 text-orange-600 text-xl"></i>
                                    Pending Evaluations
                                </h3>
                            ...
                            <?php if (!empty($unevaluated_employees)): ?>
                                        ...
                                        <div class="evaluation-row sliding-line">
                                            ...
                                            <div class="evaluation-actions">
                                                <a href="ccs_eval.php?user_id=<?= $employee['id'] ?>" 
                                                   class="btn-animated bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-2 rounded-lg text-xs font-bold hover:shadow-lg transition-all duration-300 transform hover:scale-105 shadow-md">
                                                    Evaluate Now
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <?php if (count($unevaluated_employees) > 5): ?>
                                    <div class="mt-4 text-center">
                                        <a href="ccs_eval.php" class="btn-animated text-gray-700 hover:text-gray-900 text-sm font-bold inline-flex items-center border-2 border-gray-700 px-4 py-2 rounded-lg hover:bg-gray-700 hover:text-white transition-all duration-300">
    ...
    <div id="notificationModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="modal-container bg-white rounded-2xl shadow-2xl absolute top-4 right-4 w-96 max-w-sm">
                            ...
                            <div class="flex items-start space-x-3">
                                <?php if ($notification['type'] === 'evaluation'): ?>
                                    <div class="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0">
                                        <i class="ri-file-list-3-line text-orange-600 text-sm"></i>
                                    </div>
            ...
            <div class="p-4 border-t border-gray-200">
                <button class="w-full py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors font-medium" onclick="markAllAsRead()">
                    Mark all as read
                </button>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl modal-container w-full max-w-6xl">
            ...
            <div class="p-6 space-y-6">
                            ...
                            <tbody>
                                ...
                                <tr class="<?= $i % 2 === 0 ? 'bg-gray-50' : 'bg-white' ?>">
                                    ...
                                    <td class="text-center py-2 px-1 border border-gray-300">
                                        ...
                                        <div class="w-8 h-8 flex items-center justify-center mx-auto bg-orange-600 text-white rounded">
                ...
                <div class="mt-8 flex justify-end space-x-4 pt-6 border-t">
                    ...
                    <a href="ccs_eval.php?evaluation_id=<?= $evaluation_details['id'] ?>&user_id=<?= $evaluation_details['user_id'] ?>" class="btn-animated px-6 py-2 bg-gray-600 text-white rounded hover:bg-gray-700 transition-colors">
