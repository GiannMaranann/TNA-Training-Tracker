...
<body class="min-h-screen bg-white no-horizontal-scroll <?php echo isset($show_evaluation_modal) && $show_evaluation_modal ? 'overflow-hidden' : ''; ?>">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside class="sidebar-container ccs-gradient border-r border-blue-700">
                            ...
                            <?php if (!empty($unevaluated_employees)): ?>
                                ...
                                <?php if (count($unevaluated_employees) > 5): ?>
                                    <div class="mt-4 text-center">
                                        <a href="ccs_eval.php" class="btn-animated text-blue-900 hover:text-blue-700 text-sm font-bold inline-flex items-center border-2 border-blue-900 px-4 py-2 rounded-lg hover:bg-blue-900 hover:text-white transition-all duration-300">
        ...
        <div class="bg-white rounded-2xl shadow-2xl modal-container w-full max-w-6xl">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="mt-8 flex justify-end space-x-4 pt-6 border-t">
                    ...
                    <a href="ccs_eval.php?evaluation_id=<?= $evaluation_details['id'] ?>&user_id=<?= $evaluation_details['user_id'] ?>" class="btn-animated px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors">
