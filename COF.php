...
// Fetch COF users with their assessments ONLY for department COF
$sql = "SELECT 
            u.name,
            u.department,
            u.teaching_status,
...
<body class="min-h-screen font-sans" style="font-family: 'Poppins', sans-serif;">
  <div class="min-w-[1024px]">
    ...
    <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
        <!-- Title -->
        <h1 class="text-3xl font-bold text-gray-800">College of Fisheries</h1>
        ...
        <div class="flex items-center space-x-3">
            ...
            <div class="w-14 h-14 rounded-full overflow-hidden bg-gray-200">
                <img src="images/cof.png" alt="Logo 2" class="w-full h-full object-cover" />
            </div>
            </div>
...
<main class="max-w-7xl mx-auto px-6 pt-32 pb-8">
  <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="table-container rounded-lg border border-gray-200 mb-6">
                    <table class="min-w-full">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">No COF data found for <?= $selected_year ?>.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    function generatePDF() {
        ...
        const title = "SUMMARY OF TRAINING NEEDS ASSESSMENT FORMS COF";
        ...
        doc.save("Summary_of_Training_Needs_Assessment_Forms_COF.pdf");
    }
    </script>
