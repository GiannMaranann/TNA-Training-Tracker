...
try {
    // UPDATED query - Only show users with non-null teaching_status for CFND department
    $sql = "SELECT 
                u.id AS user_id,
                u.name,
                u.department,
...
<head>
    ...
    <title>CFND Evaluation - LSPU</title>
        ...
        <aside class="sidebar-container cfnd-gradient border-r border-pink-600">
            <div class="sidebar-content">
                ...
                <div class="navigation-section mb-3">
                    <nav class="mb-3">
                        <div class="space-y-1">
                            <a href="CFND.php" class="flex items-center px-3 py-2 text-white/90 font-semibold rounded-xl sidebar-link sliding-line">
                                <i class="ri-dashboard-line mr-2 text-base"></i>
                                <span class="text-sm">Dashboard</span>
                            </a>
                            <a href="cfnd_eval.php" class="flex items-center px-3 py-2 text-white font-semibold rounded-xl sidebar-link active sliding-line active">
        ...
        <div class="main-content">
            ...
            <header class="bg-gradient-to-r from-pink-800 to-pink-700 border-b border-pink-600">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="min-w-0">
                        ...
                        <p class="text-white/70 text-sm mt-1 truncate">College of Food Nutrition and Dietetics - Faculty Evaluation Management</p>
                    </div>
            ...
            <main class="p-6 bg-gray-50 min-h-full">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">CFND Faculty Evaluations</h2>
                        <p class="text-sm text-gray-500 mt-1">View and manage CFND faculty training evaluations</p>
                        <p class="text-xs text-pink-600 mt-1 sliding-line">
                    ...
                    <div class="relative w-full md:w-96">
                        ...
                        <input type="search" id="search-input" class="search-input w-full pl-10 pr-4 py-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 focus:border-pink-500 focus:ring-1 focus:ring-pink-500" placeholder="Search by name...">
                    </div>
                </div>
                                ...
                                <tbody id="evaluation-table-body">
                                    <?php if ($result && $result->num_rows > 0): ?>
                                        ...
                                        while ($row = $result->fetch_assoc()): 
                                            ...
                                            $department = $row['department'] ?? 'CFND';
                                            ...
                                            <tr data-name="<?= htmlspecialchars($row['name']) ?>" 
                                                ...
                                                <td class="text-right">
                                                    <div class="flex justify-end space-x-2">
                                                        ...
                                                        <button 
                                                            type="button"
                                                            class="evaluate-btn action-btn btn-animated bg-gradient-to-r from-pink-600 to-pink-700 text-white hover:from-pink-700 hover:to-pink-800"
                                            ...
                                            <td colspan="6" class="px-6 py-8 text-center">
                                                <div class="flex flex-col items-center justify-center py-8">
                                                    ...
                                                    <h3 class="text-lg font-medium text-gray-900">
                                                        <?= $error_message ? 'Database Error' : 'No CFND faculty found' ?>
                                                    </h3>
                                                    <p class="mt-1 text-sm text-gray-500">
                                                        <?= $error_message ? 'Please check your database connection' : 'No CFND faculty found with teaching status.' ?>
                                                    </p>
                                                    <?php if (!$error_message): ?>
