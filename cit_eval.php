...
try {
    // UPDATED query - Only show users with non-null teaching_status for CIT department
    $sql = "SELECT 
                u.id AS user_id,
                u.name,
                u.department,
...
<head>
    ...
    <title>CIT Evaluation - LSPU</title>
        ...
        <aside class="sidebar-container cit-gradient border-r border-red-600">
            <div class="sidebar-content">
                ...
                <div class="navigation-section mb-3">
                    <nav class="mb-3">
                        <div class="space-y-1">
                            <a href="CIT.php" class="flex items-center px-3 py-2 text-white/90 font-semibold rounded-xl sidebar-link sliding-line">
                                <i class="ri-dashboard-line mr-2 text-base"></i>
                                <span class="text-sm">Dashboard</span>
                            </a>
                            <a href="cit_eval.php" class="flex items-center px-3 py-2 text-white font-semibold rounded-xl sidebar-link active sliding-line active">
        ...
        <div class="main-content">
            ...
            <header class="bg-gradient-to-r from-red-800 to-red-700 border-b border-red-600">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="min-w-0">
                        ...
                        <p class="text-white/70 text-sm mt-1 truncate">College of Industrial Technology - Faculty Evaluation Management</p>
                    </div>
            ...
            <main class="p-6 bg-gray-50 min-h-full">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">CIT Faculty Evaluations</h2>
                        <p class="text-sm text-gray-500 mt-1">View and manage CIT faculty training evaluations</p>
                        <p class="text-xs text-red-600 mt-1 sliding-line">
                    ...
                    <div class="relative w-full md:w-96">
                        ...
                        <input type="search" id="search-input" class="search-input w-full pl-10 pr-4 py-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 focus:border-red-500 focus:ring-1 focus:ring-red-500" placeholder="Search by name...">
                    </div>
                </div>
                                            ...
                                            <tr data-name="<?= htmlspecialchars($row['name']) ?>" 
                                                ...
                                                <td class="text-right">
                                                    <div class="flex justify-end space-x-2">
                                                        ...
                                                        <button 
                                                            type="button"
                                                            class="evaluate-btn action-btn btn-animated bg-gradient-to-r from-red-600 to-red-700 text-white hover:from-red-700 hover:to-red-800"
                                            ...
                                            <td colspan="6" class="px-6 py-8 text-center">
                                                <div class="flex flex-col items-center justify-center py-8">
                                                    ...
                                                    <h3 class="text-lg font-medium text-gray-900">
                                                        <?= $error_message ? 'Database Error' : 'No CIT faculty found' ?>
                                                    </h3>
                                                    <p class="mt-1 text-sm text-gray-500">
                                                        <?= $error_message ? 'Please check your database connection' : 'No CIT faculty found with teaching status.' ?>
                                                    </p>
                                                    <?php if (!$error_message): ?>
