...
<body class="min-h-screen bg-white no-horizontal-scroll">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside class="sidebar-container bg-gradient-to-b from-purple-900 to-purple-800 border-r border-purple-700">
            <div class="sidebar-content">
                    ...
                    <div class="text-center relative z-10">
                        ...
                        <div class="border-t border-white/30 pt-2">
                            ...
                            <div class="mt-2 pt-2 border-t border-white/30">
                                ...
                                <p class="text-xs opacity-80 mt-1 font-semibold text-purple-200">A.Y. 2024-2025</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="navigation-section mb-3">
                    <nav class="mb-3">
                        <div class="space-y-1">
                            <a href="CAS.php" class="flex items-center px-3 py-2 text-white font-semibold rounded-xl sidebar-link">
                                <i class="ri-dashboard-line mr-2 text-base"></i>
                                <span class="text-sm">Dashboard</span>
                            </a>
                            <a href="cas_eval.php" class="flex items-center px-3 py-2 text-white font-semibold rounded-xl sidebar-link active">
            ...
            <header class="bg-gradient-to-r from-purple-800 to-purple-700 border-b border-purple-600">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="min-w-0">
                        ...
                        <p class="text-white/70 text-sm mt-1">College of Arts & Sciences - Evaluation Dashboard</p>
                    </div>
                                        ...
                                        ?>
                                            <tr data-name="<?= htmlspecialchars($row['name']) ?>" 
                                                ...
                                                <td>
                                                    ...
                                                    <span class="status-badge <?= $type === 'teaching' ? 'bg-purple-500 text-white' : 'bg-indigo-500 text-white' ?>">
                                                ...
                                                <td class="text-right">
                                                    <div class="flex justify-end space-x-2">
                                                        ...
                                                        <button 
                                                            type="button"
                                                            class="evaluate-btn action-btn bg-gradient-to-r from-purple-600 to-purple-700 text-white hover:from-purple-700 hover:to-purple-800"
