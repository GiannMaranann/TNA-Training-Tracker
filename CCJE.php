...
// Fetch CCJE users with their assessments ONLY for department CCJE
$sql = "SELECT 
            u.name,
            u.department,
            u.teaching_status,
...
<body class="min-h-screen font-sans" style="font-family: 'Poppins', sans-serif;">
  <div class="min-w-[1024px]">
    ...
    <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
        <!-- Title -->
        <h1 class="text-3xl font-bold text-gray-800">College of Criminal Justice Education</h1>
        ...
        <div class="flex items-center space-x-3">
            ...
            <div class="w-14 h-14 rounded-full overflow-hidden bg-gray-200">
                <img src="images/ccje.png" alt="Logo 2" class="w-full h-full object-cover" />
            </div>
            </div>
    ...
    function generatePDF() {
        ...
        const title = "SUMMARY OF TRAINING NEEDS ASSESSMENT FORMS CCJE";
        ...
        doc.save("Summary_of_Training_Needs_Assessment_Forms_CCJE.pdf");
    }
    </script>
