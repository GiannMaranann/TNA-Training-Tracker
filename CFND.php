...
try {
    ...
    // Get unevaluated employees (CFND users without any evaluation record)
...
// Get real-time notifications for CFND
$notifications = [];
try {
    // Recent evaluations for CFND
    ...
    // Pending evaluations count for CFND
    ...
    if ($pending_count) {
        ...
        if ($pending_row['count'] > 0) {
            $notifications[] = [
                'type' => 'pending',
                'message' => "You have {$pending_row['count']} pending evaluations in CFND",
...
<head>
    ...
    <style>
        ...
        /* Enhanced Sidebar Link Animations - PINK AND WHITE THEME */
        .sidebar-link {
            transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
            border-radius: 15px;
            margin: 4px 0;
        ...
        .stat-card::before {
            ...
            right: 0;
            height: 5px;
            background: linear-gradient(90deg, #ffffff, #fdf2f8);
            transform: scaleX(0);
        ...
        .sliding-line.active::after {
            left: 0;
            background: linear-gradient(90deg, #ffffff, #fdf2f8, #ffffff);
...
<body class="min-h-screen bg-white no-horizontal-scroll <?php echo $show_evaluation_modal ? 'overflow-hidden' : ''; ?>">
    <div class="flex h-screen">
        <!-- Sidebar - PINK AND WHITE THEME -->
        <aside class="sidebar-container cfnd-gradient border-r border-pink-600">
            <div class="sidebar-content">
                    ...
                    <div class="text-center relative z-10">
                        ...
                        <div class="border-t border-white/30 pt-2">
                            ...
                            <div class="mt-2 pt-2 border-t border-white/30">
                                ...
                                <p class="text-xs opacity-80 mt-1 font-semibold text-accent-white">A.Y. 2024-2025</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="navigation-section mb-3">
                    <nav class="mb-3">
                        <div class="space-y-1">
                            <a href="CFND.php" class="flex items-center px-3 py-2 text-white font-semibold rounded-xl sidebar-link active sliding-line active">
                                <i class="ri-dashboard-line mr-2 text-base"></i>
                                <span class="text-sm">Dashboard</span>
                                <i class="ri-arrow-right-s-line ml-auto text-base"></i>
                            </a>
                            <a href="cfnd_eval.php" class="flex items-center px-3 py-2 text-white/90 font-semibold rounded-xl sidebar-link sliding-line">
        ...
        <div class="main-content">
            <!-- Header -->
            <header class="bg-gradient-to-r from-pink-800 to-pink-700 border-b border-pink-600">
                <div class="flex justify-between items-center px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4 flex-shrink-0">
                        <!-- Notification Bell -->
                        <div class="relative">
                            <button class="notification-bell text-white hover:text-pink-200 transition-colors" onclick="showNotifications()">
            ...
            <main class="p-6 bg-gray-50 min-h-full">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="card sliding-line">
                        <div class="p-4 card-content">
                            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
                                <i class="ri-progress-4-line mr-2 text-pink-700 text-xl"></i>
                    ...
                    <div class="card sliding-line">
                        <div class="p-4 card-content">
                            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
                                <i class="ri-pie-chart-line mr-2 text-pink-700 text-xl"></i>
                                Faculty Distribution
                            </h3>
                            <div class="h-64">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="p-4 card-content">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-bold text-gray-800 flex items-center">
                                    <i class="ri-time-line mr-2 text-pink-600 text-xl"></i>
                                    Pending Evaluations
                                </h3>
                                <span class="bg-pink-100 text-pink-800 text-xs font-bold px-2 py-1 rounded-full border border-pink-300 status-badge">
                            ...
                            <?php if (!empty($unevaluated_employees)): ?>
                                    ...
                                    <?php foreach (array_slice($unevaluated_employees, 0, 5) as $employee): ?>
                                        <div class="evaluation-row sliding-line">
                                            ...
                                            <div class="evaluation-actions">
                                                <a href="cfnd_eval.php?user_id=<?= $employee['id'] ?>" 
                                                   class="btn-animated bg-gradient-to-r from-pink-500 to-pink-600 text-white px-4 py-2 rounded-lg text-xs font-bold hover:shadow-lg transition-all duration-300 transform hover:scale-105 shadow-md">
                                                    Evaluate Now
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <?php if (count($unevaluated_employees) > 5): ?>
                                    <div class="mt-4 text-center">
                                        <a href="cfnd_eval.php" class="btn-animated text-pink-700 hover:text-pink-900 text-sm font-bold inline-flex items-center border-2 border-pink-700 px-4 py-2 rounded-lg hover:bg-pink-700 hover:text-white transition-all duration-300">
                    ...
                    <div class="card sliding-line">
                        <div class="p-4 card-content">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-bold text-gray-800 flex items-center">
                                    <i class="ri-history-line mr-2 text-pink-700 text-xl"></i>
                                    Recent Evaluations
                                </h3>
                                <span class="bg-pink-100 text-pink-800 text-xs font-bold px-2 py-1 rounded-full border border-pink-300 status-badge">
                                                ...
                                                <div class="flex gap-2">
                                                    ...
                                                    <form method="POST" action="" class="m-0">
                                                        ...
                                                        <button type="submit" name="view_evaluation" 
                                                                class="btn-animated bg-gradient-to-r from-pink-700 to-pink-800 text-white px-3 py-1.5 rounded text-xs font-bold hover:shadow-md transition-all duration-300">
                                                            View
                                                        </button>
                                                    </form>
                                                </div>
    ...
    <div id="notificationModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="modal-container bg-white rounded-2xl shadow-2xl absolute top-4 right-4 w-96 max-w-sm">
                            ...
                            <div class="flex items-start space-x-3">
                                <?php if ($notification['type'] === 'evaluation'): ?>
                                    <div class="w-8 h-8 bg-pink-100 rounded-full flex items-center justify-center flex-shrink-0">
                                        <i class="ri-file-list-3-line text-pink-600 text-sm"></i>
                                    </div>
            ...
            <div class="p-4 border-t border-gray-200">
                <button class="w-full py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors font-medium" onclick="markAllAsRead()">
                    Mark all as read
                </button>
            </div>
        </div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 modal-backdrop">
        <div class="bg-white rounded-2xl shadow-2xl modal-container w-full max-w-6xl">
            <!-- Modal Header -->
            <div class="bg-gradient-to-r from-pink-800 to-pink-700 text-white p-6 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="p-6 space-y-6">
                            ...
                            <tbody>
                                ...
                                <tr class="<?= $i % 2 === 0 ? 'bg-gray-50' : 'bg-white' ?>">
                                    ...
                                    <td class="text-center py-2 px-1 border border-gray-300">
                                        ...
                                        <div class="w-8 h-8 flex items-center justify-center mx-auto bg-pink-600 text-white rounded">
                                ...
                                <div class="flex justify-between items-start">
                                    <div>
                                        <p class="font-medium text-gray-800">
                                            Status changed from 
                                            <span class="text-pink-600"><?= $history['from_status'] ? ucfirst($history['from_status']) : 'None' ?></span> 
                                            to 
                ...
                <div class="mt-8 flex justify-end space-x-4 pt-6 border-t">
                    ...
                    <a href="cfnd_eval.php?evaluation_id=<?= $evaluation_details['id'] ?>&user_id=<?= $evaluation_details['user_id'] ?>" class="btn-animated px-6 py-2 bg-pink-600 text-white rounded hover:bg-pink-700 transition-colors">
