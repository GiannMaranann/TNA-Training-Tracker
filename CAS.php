...
// Fetch CAS users with their assessments ONLY for department CAS
$sql = "SELECT 
            u.name,
            u.department,
            u.teaching_status,
...
<header class="bg-white shadow-sm fixed top-0 left-0 w-full z-50">
  <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
    <!-- Title -->
    <h1 class="text-3xl font-bold text-gray-800">College of Arts and Sciences</h1>
    ...
    <div class="flex items-center space-x-6">
            ...
            <div id="notifPopup" class="absolute right-0 mt-3 w-96 bg-white border border-gray-200 rounded-2xl shadow-xl hidden z-50">
              <div class="relative p-5">
                ...
                <div class="text-sm text-gray-700 space-y-2">
                  ...
                  <p>It has been over <span class="font-medium">3 months</span> since your last employee evaluation...</p>
                  <p class="font-semibold text-gray-900">
                    Please complete the evaluation process as soon as possible to ensure compliance...
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="flex items-center space-x-3">
        ...
        <div class="flex items-center space-x-1">
          ...
          <div class="w-14 h-14 rounded-full overflow-hidden bg-gray-200">
            <img src="images/cas.png" alt="Logo 2" class="w-full h-full object-cover" />
          </div>
        </div>
  ...
  <div class="bg-white rounded-lg shadow-sm p-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
      ...
      <div class="relative w-full md:w-96">
        ...
        <div id="search-suggestions" class="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg hidden">
    ...
    function generatePDF() {
        ...
        const title = "SUMMARY OF TRAINING NEEDS ASSESSMENT FORMS CAS";
        ...
        doc.save("Summary_of_Training_Needs_Assessment_Forms_CAS.pdf");
    }
    </script>
