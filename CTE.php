...
<head>
    ...
    <style>
        ...
        /* Enhanced Sidebar Link Animations - BLUE AND YELLOW THEME */
        .sidebar-link {
            transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
            border-radius: 15px;
            margin: 4px 0;
...
<body class="min-h-screen bg-white no-horizontal-scroll <?php echo $show_evaluation_modal ? 'overflow-hidden' : ''; ?>">
    <div class="flex h-screen">
        <!-- Sidebar - BLUE AND YELLOW THEME -->
        <aside class="sidebar-container cte-gradient border-r border-blue-600">
            <div class="sidebar-content">
                ...
                <div class="navigation-section mb-3">
                    <nav class="mb-3">
                        <div class="space-y-1">
                            <a href="CTE.php" class="flex items-center px-3 py-2 text-white font-semibold rounded-xl sidebar-link active sliding-line active">
                                <i class="ri-dashboard-line mr-2 text-base"></i>
                                <span class="text-sm">Dashboard</span>
                                <i class="ri-arrow-right-s-line ml-auto text-base"></i>
                            </a>
                            <a href="cte_eval.php" class="flex items-center px-3 py-2 text-white/90 font-semibold rounded-xl sidebar-link sliding-line">
            ...
            <header class="bg-gradient-to-r from-blue-800 to-blue-700 border-b border-blue-600">
                <div class="flex justify-between items-center px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4 flex-shrink-0">
                        <!-- Notification Bell -->
                        <div class="relative">
                            <button class="notification-bell text-white hover:text-blue-200 transition-colors" onclick="showNotifications()">
            ...
            <main class="p-6 bg-gray-50 min-h-full">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="card sliding-line">
                        <div class="p-4 card-content">
                            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
                                <i class="ri-progress-4-line mr-2 text-blue-700 text-xl"></i>
                    ...
                    <div class="card sliding-line">
                        <div class="p-4 card-content">
                            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
                                <i class="ri-pie-chart-line mr-2 text-blue-700 text-xl"></i>
                                Faculty Distribution
                            </h3>
                            <div class="h-64">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <?php if (!empty($unevaluated_faculty)): ?>
                                ...
                                <?php if (count($unevaluated_faculty) > 5): ?>
                                    <div class="mt-4 text-center">
                                        <a href="cte_eval.php" class="btn-animated text-blue-700 hover:text-blue-900 text-sm font-bold inline-flex items-center border-2 border-blue-700 px-4 py-2 rounded-lg hover:bg-blue-700 hover:text-white transition-all duration-300">
                    ...
                    <div class="card sliding-line">
                        <div class="p-4 card-content">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-bold text-gray-800 flex items-center">
                                    <i class="ri-history-line mr-2 text-blue-700 text-xl"></i>
                                    Recent Evaluations
                                </h3>
                            ...
                            <?php if (!empty($recent_evaluations)): ?>
                                <div class="space-y-3">
                                    ...
                                    ?>
                                        <div class="evaluation-item flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 sliding-line">
                                            ...
                                            <div class="flex items-center space-x-2 flex-shrink-0 ml-2">
                                                ...
                                                <form method="POST" action="" class="m-0">
                                                    ...
                                                    <button type="submit" name="view_evaluation" 
                                                            class="btn-animated bg-gradient-to-r from-blue-700 to-blue-800 text-white px-3 py-1.5 rounded-lg text-xs font-bold hover:shadow-md transition-all duration-300 shadow-sm">
            ...
            <div class="max-h-96 overflow-y-auto" id="notificationList">
                <div class="p-4 text-center">
                    <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                        <i class="ri-notification-off-line text-blue-600 text-xl"></i>
                    </div>
                    <p class="text-gray-500 text-sm">No notifications</p>
                </div>
            </div>
            <div class="p-4 border-t border-gray-200">
                <button class="w-full py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium" onclick="hideNotifications()">
                    Close
                </button>
            </div>
        </div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 modal-backdrop">
        <div class="bg-white rounded-2xl shadow-2xl modal-container w-full max-w-6xl">
            <!-- Modal Header -->
            <div class="bg-gradient-to-r from-blue-800 to-blue-700 text-white p-6 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="p-6 space-y-6">
                            ...
                            <tbody>
                                ...
                                <tr class="<?= $i % 2 === 0 ? 'bg-gray-50' : 'bg-white' ?>">
                                    ...
                                    <td class="text-center py-2 px-1 border border-gray-300">
                                        ...
                                        <div class="w-8 h-8 flex items-center justify-center mx-auto bg-blue-600 text-white rounded">
                ...
                <div class="mt-8 flex justify-end space-x-4 pt-6 border-t">
                    ...
                    <a href="cte_eval.php?evaluation_id=<?= $evaluation_details['id'] ?>&user_id=<?= $evaluation_details['user_id'] ?>" class="btn-animated px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors">
