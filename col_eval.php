...
try {
    // UPDATED query - Only show users with non-null teaching_status for COL department
    $sql = "SELECT 
                u.id AS user_id,
                u.name,
                u.department,
...
<head>
    ...
    <title>COL Evaluation - LSPU</title>
    ...
    <style>
        ...
        .status-submitted {
            background: linear-gradient(135deg, #8b4513 0%, #4c1d95 100%);
            color: white;
        }
        ...
        <aside class="sidebar-container col-gradient border-r border-gray-800">
            <div class="sidebar-content">
                ...
                <div class="navigation-section mb-3">
                    <nav class="mb-3">
                        <div class="space-y-1">
                            <a href="COL.php" class="flex items-center px-3 py-2 text-white/90 font-semibold rounded-xl sidebar-link sliding-line">
                                <i class="ri-dashboard-line mr-2 text-base"></i>
                                <span class="text-sm">Dashboard</span>
                            </a>
                            <a href="col_eval.php" class="flex items-center px-3 py-2 text-white font-semibold rounded-xl sidebar-link active sliding-line active">
        ...
        <div class="main-content">
            ...
            <header class="bg-gradient-to-r from-gray-900 to-gray-800 border-b border-gray-700">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="min-w-0">
                        <h1 class="text-2xl font-bold text-white truncate">Welcome back, <?= htmlspecialchars($user['name'] ?? 'COL Admin') ?>! 👨‍⚖️</h1>
                        <p class="text-white/70 text-sm mt-1 truncate">College of Law - Faculty Evaluation Management</p>
                    </div>
            ...
            <main class="p-6 bg-gray-50 min-h-full">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">COL Faculty Evaluations</h2>
                        <p class="text-sm text-gray-500 mt-1">View and manage COL faculty training evaluations</p>
                                            ...
                                            <td colspan="6" class="px-6 py-8 text-center">
                                                <div class="flex flex-col items-center justify-center py-8">
                                                    ...
                                                    <h3 class="text-lg font-medium text-gray-900">
                                                        <?= $error_message ? 'Database Error' : 'No COL faculty found' ?>
                                                    </h3>
                                                    <p class="mt-1 text-sm text-gray-500">
                                                        <?= $error_message ? 'Please check your database connection' : 'No COL faculty found with teaching status.' ?>
                                                    </p>
                                                    <?php if (!$error_message): ?>
